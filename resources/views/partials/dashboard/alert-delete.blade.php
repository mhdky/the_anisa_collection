@foreach ($products as $product)
    <div class="alertHapusProductAdm bg-[#5555556d] fixed top-0 right-0 bottom-0 left-0 z-30 justify-center items-center hidden">
        <div class="bg-white w-56 h-40 rounded-md flex flex-col justify-center items-center">
            ...
            <div class="flex justify-center items-center">
                ...
                <button type="submit" onclick="deleteProduct({{ $product->id }})" class="text-zinc-600 text-[14px] ml-2 hover:text-black-primary">Hapus</button>
            </div>
        </div>
    </div>
@endforeach